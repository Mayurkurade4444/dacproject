...
public class AppointmentService {
	...
	public Appointmententity saveAppointment(Appointmententity a) {
		
		Appointmententity aa = arepo.save(a);
		if(aa != null) {
	...
	public Appointmententity cancelAppointment(Appointmententity a) {
		Appointmententity aa = arepo.save(a);
		if(aa != null) {
			SimpleMailMessage smm = new SimpleMailMessage();
			smm.setFrom("connecttoyourdoctor@gmail.com");
	...
	public List<Appointmententity> getAppointmentByDid(Doctor d, java.util.Date date1) {	
		return arepo.getAppointmentByDid(d, date1);
	}
	
	public List<Appointmententity> getAppointmentHistoryByDid(Doctor d, java.util.Date date1) {	
		return arepo.getAppointmentHistoryByDid(d, date1);
	}

	public List<Appointmententity> getAppointmentByPatient(Patient p, java.util.Date date1) {
		return arepo.getAppointmentByPatient(p,date1);
	}

	public List<Appointmententity> getAppointmentHistoryByPid(Patient p, java.util.Date date1) {
